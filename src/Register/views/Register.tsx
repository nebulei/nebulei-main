                ...
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="space-y-4 md:space-y-6" action="#">
                        ...
                        <div>
                            ...
                            <input type="password" name="password" id="password" placeholder="•••••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"></input>
                        </div>
                        <div className="flex items-center justify-between">
                            <div className="flex items-start">
                                <div className="flex items-center h-5">
                                  <input id="remember" aria-describedby="remember" type="checkbox" className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary"></input>
                                </div>
                        ...
                        <button type="submit" className="w-full nebulei-font text-white bg-primary-300 hover:bg-primary-400 focus:ring-4 focus:outline-none focus:ring-primary-200 font-medium rounded-full text-sm px-5 py-2.5 text-center">Join</button>
                    </form>
                </div>
            </div>
        </div>
